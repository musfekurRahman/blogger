                ...
                <form action="{{ route('content.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="headline" class="form-label">Category
                            <span data-bs-toggle="tooltip" data-bs-placement="top" title="You can select multiple categories but maximum limit of selection is 10. Can be set your custom tags also. Just type and enter">
                                <i class="fa-solid fa-circle-question"></i>
                            </span>
                        </label>
                        <select class="form-control tags" name="categories[]" id="categories" multiple="multiple" required>
